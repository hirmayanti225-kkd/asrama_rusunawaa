...
<aside class="right-side">
    ...
    <section class="content">
        ...
        <div class="card" style="width: 360px ; margin-bottom: 100px">
            <div class="card-body">
                <?php foreach ($out as $a) : ?>
                <form method="POST" action="<?php echo base_url('data_keluar/update_data_aksi') ?>">

                    <div class="form-group">
                        <label>Nama</label>
                        <input type="hidden" name="id_checkout" class="form-control"
                            value="<?php echo $a->id_checkout ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_keluar" class="form-control"
                            value="<?php echo $a->tanggal_keluar ?>">

                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="allTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <tr>
                                        <td> <a href="<?php echo base_url('notif_pengumuman/tandaisudahdibacasemua') ?>"
                                                class="btn btn-success"
                                                onclick="return confirm('Tandai semua sudah dibaca');">
                                                Tandai
                                                Sudah Dibaca Semua</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <table class="table table-bordered" id="allTable" width="100%" cellspacing="0">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 550px;">Isi Pengumuman</th>
                            ...
                            <tbody>
                                <?php $no = 1;
                                foreach ($notifikasi_p as $nk) : ?>
                                <tr>
                                    <td class="text-center"><?php echo $no++ ?></td>
                                    <td class="text-center"><?php echo $nk->keterangan ?></td>
                                    <td class="text-center"><?php echo $nk->isi_pengumuman ?></td>
                                    <td>
                                        <?php if ($nk->is_read == 0) : ?>
                                        <a href="<?php echo base_url('notif_pengumuman/tandaisudahdibaca/' . $nk->id) ?>"
                                    ...
                                    <td>
                                        <center>
                                            <a onclick="return confirm('Yakin Hapus?')" class="btn btn-sm btn-danger"
                                                href="<?php echo base_url('notif_pengumuman/hapus/' . $nk->id) ?>"><i
                                                    class="fa fa-eraser"></i></a>
                                            <a class="btn btn-sm btn-success"
                                                href="<?php echo base_url('pengumuman/tampil/' . $nk->id) ?>"><i
                                                    class="fa fa-eye"></i></a>
                                        </center>
                                    </td>
                                </tr>

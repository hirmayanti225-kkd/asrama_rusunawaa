    ...
    <section class="content">
        ...
        <div class="card" style="width: 60% ; margin-bottom: 100px">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo base_url('data_pengguna/update_data_member_aksi') ?>"
                    ...
                    <a href="<?php echo base_url('member_data') ?>" class="btn btn-warning">Kembali</a>
